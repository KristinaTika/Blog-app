...
export const renderSingleAuthor = (author) => {
    ...
    <span class="all-authors"><a href="#" class="back-to-authors"> &#8592; All authors </a></span>
    <h1>${author.name}</h1>
